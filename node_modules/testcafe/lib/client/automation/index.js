...
(function () {
    function initTestCafeAutomation(window, isIFrameWithoutSrc) {
        ...
        (function (hammerhead, testCafeCore, Promise$g, testCafeUI) {
    ...
    Promise$g = Promise$g && Object.prototype.hasOwnProperty.call(Promise$g, 'default') ? Promise$g['default'] : Promise$g;
    ...
    var nativeMethods = hammerhead__default.nativeMethods, Promise = hammerhead__default.Promise;
    var domUtils = testCafeCore__default.domUtils, ScrollAutomation = testCafeCore__default.ScrollAutomation;
    initializeAdapter({
        PromiseCtor: Promise,
    ...
    var DispatchEventAutomation = /** @class */ (function () {
        ...
        DispatchEventAutomation._getEventCtorFromNativeMethods = function (eventCtor) {
            var ctor = nativeMethods$1['Window' + eventCtor] || DispatchEventAutomation._getEventCtorFromWindow(eventCtor);
            return ctor;
        };
    ...
    ***************************************************************************** */
    ...
    function __awaiter(thisArg, _arguments, P, generator) {
        ...
        return new (P || (P = Promise$g))(function (resolve, reject) {
    ...
    function findElementOrNonEmptyChildFromPoint(x, y, element) {
        ...
        var isNonEmptyChild = domUtils$1.containsElement(element, topElement) &&
            nativeMethods$2.nodeTextContentGetter.call(topElement).length;
    ...
    function correctTopElementByExpectedElement(topElement, expectedElement) {
        ...
        var shouldSearchForMultilineLink = isLinkOrChildExpected && !isTopElementChildOfLink &&
            nativeMethods$2.nodeTextContentGetter.call(expectedElement).length;
    ...
    function nextTick () {
        return new Promise$2(function (resolve) { return nativeMethods$3.setTimeout.call(window, resolve, 0); });
    }
    ...
    var ScrollAutomation$1 = testCafeCore__default.ScrollAutomation;
    ...
    var MoveAutomation = /** @class */ (function () {
        ...
        MoveAutomation.prototype._move = function (endPoint) {
            ...
            var startTime = nativeMethods$5.dateNow();
            ...
            return whilst(function () { return !currPosition.eql(endPoint); }, function () {
                if (_this._needMoveCursorImmediately())
                    ...
                    var progress = Math.min((nativeMethods$5.dateNow() - startTime) / movingTime, 1);
        ...
        MoveAutomation.prototype._scroll = function () {
            ...
            var scrollAutomation = new ScrollAutomation$1(this.element, scrollOptions);
    ...
    function focusAndSetSelection(element, simulateFocus, caretPos) {
        var _this = this;
        return new Promise$6(function (resolve) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var ClickAutomation = /** @class */ (function (_super) {
        ...
        ClickAutomation.prototype.run = function (useStrictElementCheck) {
            ...
            return this
                ...
                return Promise$7.all([delay(_this.automationSettings.mouseActionStepDelay), _this._mousedown(eventArgs)]);
            })
            ...
            return getElementFromPoint(cursor.getPosition())
                ...
                if (draggable && featureDetection$4.hasDataTransfer && !_this.skipDefaultDragBehavior) {
                    ...
                    if (isLink || domUtils$7.isImgElement(_this.dragElement)) {
                        ...
                        var outerHTML = htmlUtils.cleanUpHtml(nativeMethods$9.elementOuterHTMLGetter.call(_this.dragElement));
    ...
    var DragAutomationBase = /** @class */ (function (_super) {
        ...
        DragAutomationBase.prototype.run = function (useStrictElementCheck) {
            ...
            return this
                ...
                // mousedown event regardless of how long mousedown event handlers were executing
                return Promise$9.all([testCafeCore.delay(_this.automationSettings.mouseActionStepDelay), _this._mousedown(eventArgs)]);
            })
    ...
    var PressAutomation = /** @class */ (function () {
        ...
        PressAutomation.prototype._down = function (keyPressSimulator) {
            ...
            return Promise$c.resolve(keyDownPrevented);
        };
    ...
    var RClickAutomation = /** @class */ (function (_super) {
        ...
        RClickAutomation.prototype.run = function (useStrictElementCheck) {
            ...
            return this
                ...
                // NOTE: we should raise mouseup event with 'mouseActionStepDelay' after we trigger
                // mousedown event regardless of how long mousedown event handlers were executing
                return Promise$d.all([delay$3(_this.automationSettings.mouseActionStepDelay), _this._mousedown(eventArgs)]);
            })
                .then(function () { return _this._mouseup(eventArgs); })
    ...
    var SelectBaseAutomation = /** @class */ (function (_super) {
        ...
        SelectBaseAutomation.prototype._focus = function () {
            var _this = this;
            return new Promise$e(function (resolve) {
                // NOTE: If the target element is a child of a contentEditable element, we need to call focus for its parent
    ...
    var Promise$f = hammerhead__default.Promise;
